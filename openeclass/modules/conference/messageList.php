...
<head>
<meta http-equiv="refresh" content="30; url=<?= htmlspecialchars($_SERVER['PHP_SELF']) ?>" />
...
if (isset($chatLine) and trim($chatLine) != '') {
	...
	fwrite($fchat,$timeNow.' - '.htmlspecialchars($nick, ENT_QUOTES, 'UTF-8').' : '.stripslashes($chatLine)."\n");
	fclose($fchat);
}
}
